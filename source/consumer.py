...
response = requests.get(url=baseurl + "/satelitte/1857f0d9-1531-4385-84f7-ae57aadf6d70")
print(response.status_code)
print(response.json())
print(response.headers)

print("\nDeleting satellite with uuid of 1857f0d9-1531-4385-84f7-ae57aadf6d70")
response = requests.delete(url=baseurl + "/satelitte/1857f0d9-1531-4385-84f7-ae57aadf6d70")
print(response.status_code)
print(response.json())
print(response.headers)
